...
const IdentificationScreen = ({ route, navigation }) => {
            ...
            switch (title) {
                case 'Application Tag':
                    return ( <
                        ...
                        onPress = {
                            () => navigation.navigate('Application Tag') } >
                        <
        ...
        const ApplicationTagScreen = () => {
            ...
            return ( <
                View >
                <
                TextInput label = "Set Your Application Tag"
                value = { text }
                selectionColor = '#000'
                underlineColor = '#000'
                ...
                error = { false }
                right = { < TextInput.Icon name = "close-circle-outline"
                    ...
                    Button
                    onPress = {
                        () => { HandleWriteCommand("24:0A:C4:09:69:62", "a65373b2-6942-11ec-90d6-024200120000", "a65373b2-6942-11ec-90d6-024200120100", BufferArray(`{'Tag':'Communication', 'Set Parameters': {'18':'${text}'}}`)) } }
                    title = "Save"
                    color = "#841584"
            ...
            return ( <
                ...
                <
                StackIdentification.Screen name = 'Identification Main'
                component = { IdentificationMainScreen }
                options = {
                    { headerTitle: "Identification" } }
                /> <
                StackIdentification.Screen name = 'Application Tag'
                component = { ApplicationTagScreen }
                /> <
