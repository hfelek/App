...
function Item(title, value, navigation = null, context = null, parent = null) {
    ...
    switch (title) {
        ...
        case 'Current Output':
            return (
                <TouchableOpacity style={styles.itemButton} onPress={() => navigation.navigate('Current Output1')}>
...
const CurrentOutputScreen = ({ route, navigation }) => {
...
export default CurrentOutputScreen
