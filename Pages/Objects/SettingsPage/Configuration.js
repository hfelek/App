...
const ConfigurationScreen = ({ route, navigation }) => {
  ...
  return (
    <StackDisplay.Navigator screenOptions={{ headerShown: true, headerTitleAlign: 'center' }}>
      <StackDisplay.Screen name='Configuration Main' component={ConfigurationMainScreen} options={{ headerTitle: "Display" }} />
      <StackDisplay.Screen name='Active Configuration' component={ConfigurationScreen} />
