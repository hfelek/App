                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            isTableValuesValid(hookArray) == false ? Alert.alert('Invalid Input', 'Parameters must be set regarding valid intervals!', [{
                                text: 'Ok',
                            }]) : HandleWriteCommandGroup(peripheralID, "a65373b2-6942-11ec-90d6-024200120000", "a65373b2-6942-11ec-90d6-024200120100", `{"Tag":"Custom Coefficients", "Set Parameters": {"${MenuParams.find(obj => obj.Tag == ConfigNum).Index}":"${calculatePayload(hookArray)}"}}`, context)
                        }}
