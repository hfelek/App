            ...
            switch (title) {
                ...
                case 'Configure Table':
                    return ( <
                        ...
                        onPress = {
                            () => navigation.navigate('Custom Temperature Coefficient', { Tag: title, name: title, ConfigNum: parent }) } >
                        <
                ...
                case 'Configuration':
                    return ( <
                        TouchableOpacity style = { styles.itemButton }
                        onPress = {
                            () => navigation.navigate('Configuration', { name: "Custom Temperature Coefficient" }) } >
                        <
        ...
        function Coeffs(title, value, setValue) {
            ...
            function CustomConfigurationScreen({ route, navigation }) {
                ...
                return ( <
                    ...
                    <
                    View style = {
                        [styles.pickerText, { paddingTop: 15, alignItems: "center" }] } >
                    <
                    Text style = {
                        [styles.title, { textAlign: 'center', color: 'black' }] } > Number of Temperature Points in the Table < /Text> <
                    /View>
                    ...
                    <
                    Text style = {
                        [styles.title, { textAlign: 'center', color: 'black' }] } > Number of Concentration Points in the Table < /Text> <
                    /View>
                    ...
                    <
                    Button onPress = {
                        () => navigation.navigate('Custom Temperature Coefficient', { Tag: ConfigNum, ConfigNum: ConfigNum, name: "Custom Temperature Coefficient", ConcentrationPoints: nrOfConcPoints, TemperaturePoints: nrOfTempPoints }) }
            ...
            function ConfigurationNumScreen({ route, navigation }) {
                ...
                return ( <
                    ...
                    renderItem = {
                        ({ item, index, separators }) => (renderItem(item, navigation, "hello", item.Tag)) }
            ...
            const element = (data, index, cellIndex, value, setValue) => {
                ...
                return (
                    ...
                    <
                    View style = {
                        [cellIndex == 0 ? styles.btn5 : styles.btn6, { alignItems: 'center', alignContent: "center", backgroundColor: (cellIndex == 0 || index == 0) ? "#808B97" : 'white', paddingBottom: 0, borderRadius: 0, borderBottomWidth: 0, borderBottomEndRadius: 0 }] } >
                    ...
                    maxLength = { 7 }
                    underlineColor = {
                        (cellIndex == 0 || index == 0) ? "#808B97" : 'white' }
                    ...
                    scrollEnabled = { false }
                    onChangeText = {
                        (val) => { updateCell(val, index, cellIndex, value, setValue) } }
                    /> <
                    /View>
            ...
            const text = (data, index) => ( <
                View style = {
                    [styles.btn5, { alignContent: "center", backgroundColor: 'white', paddingBottom: 0 }] } >
                <
                Text > { "value" } < /Text> <
                /View>
            );
            ...
            const TemperatureCoefficientScreen = ({ route, navigation }) => {
                    ...
                    const tableHead = [];
                    tableHead[0] = "Configuration Points"
                    const widthArr = [150]
