...
const TemperatureCoeffScreen = ({ route, navigation }) => {
  ...
  return (
    <StackTempCoeff.Navigator screenOptions={{ headerShown: true, headerStyle:styles.headerStyle, headerTitleAlign: 'center', headerLeft: () => (navigateBackFunction(false)) }}>
      ...
      <StackTempCoeff.Screen name='Temperature Coefficient Linear' component={TemperatureCoeffLinearScreen}  options={({ route }) => ({ headerShown:false,headerTitle:'Linear Coefficient'})} />
      <StackTempCoeff.Screen name='Temperature Coefficient Custom' component={TemperatureCoeffCustomScreen} options={({ route }) => ({ headerShown:false,headerTitle:'Custom Coefficients'})} />
