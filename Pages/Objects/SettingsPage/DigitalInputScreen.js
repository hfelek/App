...
const DigitalInputFunctionScreen = ({ route, navigation }) => {
    ...
    const [selection, setSelection] = React.useState(val[0].Value); /////Digital InPut Function Selection
                ...
                selection == "Configuration Control" && (
                    <View style={[styles.container1, { paddingTop: 10, alignItems: 'stretch', backgroundColor: "#ffffff" }]}>
                        <View style={[styles.pickerText, { paddingTop: 15, alignItems: "center" }]} >
                            <Text style={[styles.title, { borderBottomWidth: 2, borderBottomColor: "black" }]}>{"Choose Digital Input Assign for D-IN STATE:LOW"}</Text>
                        </View>
                        ...
                        <View style={[styles.pickerText, { paddingTop: 15, alignItems: "center" }]} >
                            <Text style={[styles.title, { borderBottomWidth: 2, borderBottomColor: "black" }]}>{"Choose Digital Input Assign for D-IN STATE:HIGH"}</Text>
                        </View>
